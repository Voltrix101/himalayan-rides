...
exports.uploadPDFAndGetURL = exports.generateTripDetailsPDF = exports.generateInvoicePDF = void 0;
 ...
 */
async function generateInvoicePDF(bookingData, paymentData) {
 ...
 */
async function generateTripDetailsPDF(bookingData) {
    return new Promise((resolve, reject) => {
        try {
            const doc = new pdfkit_1.default({
                size: 'A4',
...
exports.generateTripDetailsPDF = generateTripDetailsPDF;
/**
 * Upload PDF to Firebase Storage and get signed URL
 */
async function uploadPDFAndGetURL(filePath, bookingId, type) {
    try {
 ...
 */
function drawBookingInfo(doc, bookingData) {
    const startY = doc.y;
    // Booking info column
    doc.fontSize(14)
        .font('Helvetica-Bold')
 ...
 * Draw payment table
 */
function drawPaymentTable(doc, bookingData, paymentData) {
 ...
 */
function drawTripDetails(doc, bookingData) {
    const startY = doc.y;
    // Trip overview
    doc.fontSize(16)
        .font('Helvetica-Bold')
 ...
 */
function drawEmergencyInfo(doc, bookingData) {
    const startY = doc.y;
    // Emergency contacts
    doc.fontSize(16)
        .font('Helvetica-Bold')
...
function drawFooter(doc, message) {
    ...
    doc.fontSize(10)
        .font('Helvetica')
        .fillColor(COLORS.text)
        .text('Himalayan Rides | Email: contact@himalayanrides.com | Phone: +91-9876543210', 50, footerY + 50, { align: 'center', width: doc.page.width - 100 });
}
//# sourceMappingURL=pdf_clean.js.map