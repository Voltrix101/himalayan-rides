...
import { X, MapPin, Clock, Users, Star, Calendar, Mountain, Sunrise, Sunset } from 'lucide-react';
import { TripPlan, TourItinerary } from '../../types';

interface FluidItineraryModalProps {
  isOpen: boolean;
  onClose: () => void;
  tripPlan: TripPlan;
}
...
export function FluidItineraryModal({ isOpen, onClose, tripPlan }: FluidItineraryModalProps) {
  return (
    <AnimatePresence>
      {isOpen && (
        <motion.div
              ...
              >
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="bg-white/10 backdrop-blur-md rounded-xl p-3 border border-white/20">
                    ...
                    <div className="text-white font-semibold">{tripPlan.duration}</div>
                  </div>
                  ...
                  <div className="bg-white/10 backdrop-blur-md rounded-xl p-3 border border-white/20">
                    ...
                    <div className="text-white font-semibold">{tripPlan.groupSize.min}-{tripPlan.groupSize.max}</div>
                  </div>
                  ...
                  <div className="bg-white/10 backdrop-blur-md rounded-xl p-3 border border-white/20">
                    ...
                    <div className="text-white font-semibold">{tripPlan.difficulty}</div>
                  </div>
                  ...
                  <div className="bg-white/10 backdrop-blur-md rounded-xl p-3 border border-white/20">
                    ...
                    <div className="text-white font-semibold text-xs">{tripPlan.bestSeason?.join(', ') || 'Year-round'}</div>
                  </div>
                </div>
              </motion.div>
            </div>
            ...
            <div className="relative p-6 border-t border-white/10 backdrop-blur-xl">
              ...
              >
                <div>
                  ...
                  <div className="text-2xl font-bold text-white">₹{tripPlan.price.toLocaleString()}</div>
                </div>
